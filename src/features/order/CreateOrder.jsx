...
function CreateOrder() {
  ...
  const totalCartPrice = useSelector(getTotalPrice) + priorityPrice;
    ...
    <div className="px-4 py-6">
      ...
      <Form method="POST">
        ...
        <div className="mb-5 relative flex flex-col gap-2 sm:flex-row sm:items-center">
          ...
          <span className='absolute right-0 -top-1 md:right-[5px] md:top-[5px]'>
            {
              !position.latitude && !position.longitude && <Button onClick={handleGetAddress} disabled={isLoadingAddress} type="small">Get address</Button>
            }
          </span>
        </div>
